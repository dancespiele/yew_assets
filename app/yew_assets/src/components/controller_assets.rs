...
/// ```rust
/// use yew::prelude::*;
/// use yew_assets::{ControllerAssets, ControllerIcon};
///
/// pub struct App;
...
pub struct Props {
    /// List of ControllerIcons
    pub icon: ControllerIcon,
    /// Size of the ControllerIcon
    #[prop_or(("24".to_string(),"24".to_string()))]
    pub size: (String, String),
    /// Defines the position and dimension of the ControllerIcon
...
ChevronsUp,
                ...
                fn get_icon(
                    ...
                    match icon {
            ControllerIcon::ArrowRightCircle => get_arrowrightcircle(size, view_box, fill, class_name, id),
...
ControllerIcon::ArrowDownCircle => get_arrowdowncircle(size, view_box, fill, class_name, id),
...
ControllerIcon::CornerRightDown => get_cornerrightdown(size, view_box, fill, class_name, id),
ControllerIcon::RefreshCcw => get_refreshccw(size, view_box, fill, class_name, id),
ControllerIcon::CornerDownRight => get_cornerdownright(size, view_box, fill, class_name, id),
ControllerIcon::ArrowLeftCircle => get_arrowleftcircle(size, view_box, fill, class_name, id),
