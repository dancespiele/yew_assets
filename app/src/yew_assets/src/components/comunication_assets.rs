...
/// # ComunicationAssets
///
/// Add a svg ComunicationIcon
pub struct ComunicationAssets {
    pub props: Props,
}

#[derive(Clone, Properties)]
pub struct Props {
    /// List of ComunicationIcons
    pub icon: ComunicationIcon,
    /// Size of the ComunicationIcon
    #[prop_or(("24".to_string(),"24".to_string()))]
    pub size: (String, String),
    /// Defines the position and dimension of the ComunicationIcon
...
impl Component for ComunicationAssets {
...
Wifi,
                ...
                fn get_icon(
                    ...
                    match icon {
            ComunicationIcon::Users => get_users(size, view_box, fill, class_name, id),
ComunicationIcon::User => get_user(size, view_box, fill, class_name, id),
ComunicationIcon::UserPlus => get_userplus(size, view_box, fill, class_name, id),
ComunicationIcon::Frown => get_frown(size, view_box, fill, class_name, id),
ComunicationIcon::PhoneMissed => get_phonemissed(size, view_box, fill, class_name, id),
ComunicationIcon::PhoneCall => get_phonecall(size, view_box, fill, class_name, id),
ComunicationIcon::UserX => get_userx(size, view_box, fill, class_name, id),
ComunicationIcon::PhoneOff => get_phoneoff(size, view_box, fill, class_name, id),
ComunicationIcon::Star => get_star(size, view_box, fill, class_name, id),
ComunicationIcon::UserCheck => get_usercheck(size, view_box, fill, class_name, id),
ComunicationIcon::Meh => get_meh(size, view_box, fill, class_name, id),
ComunicationIcon::PhoneOutgoing => get_phoneoutgoing(size, view_box, fill, class_name, id),
ComunicationIcon::Smile => get_smile(size, view_box, fill, class_name, id),
ComunicationIcon::Bluetooth => get_bluetooth(size, view_box, fill, class_name, id),
ComunicationIcon::UserMinus => get_userminus(size, view_box, fill, class_name, id),
ComunicationIcon::Voicemail => get_voicemail(size, view_box, fill, class_name, id),
ComunicationIcon::PhoneIncoming => get_phoneincoming(size, view_box, fill, class_name, id),
ComunicationIcon::Phone => get_phone(size, view_box, fill, class_name, id),
ComunicationIcon::WifiOff => get_wifioff(size, view_box, fill, class_name, id),
ComunicationIcon::Mail => get_mail(size, view_box, fill, class_name, id),
ComunicationIcon::MessageCircle => get_messagecircle(size, view_box, fill, class_name, id),
ComunicationIcon::PhoneForwarded => get_phoneforwarded(size, view_box, fill, class_name, id),
ComunicationIcon::Heart => get_heart(size, view_box, fill, class_name, id),
ComunicationIcon::MessageSquare => get_messagesquare(size, view_box, fill, class_name, id),
ComunicationIcon::Wifi => get_wifi(size, view_box, fill, class_name, id),
                ...
                fn get_userplus(
                    ...
                    html!{
                        <svg xmlns="http://www.w3.org/2000/svg" witdh=size.0 height=size.1 viewBox=format!("{} {} {} {}",
                            ...
                            view_box.2,
                            view_box.3,
                        ) fill=fill id=id stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-plus"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="23" y1="11" x2="17" y2="11"></line></svg>
                    }
                }
                ...
                fn get_userx(
                    ...
                    html!{
                        <svg xmlns="http://www.w3.org/2000/svg" witdh=size.0 height=size.1 viewBox=format!("{} {} {} {}",
                            ...
                            view_box.2,
                            view_box.3,
                        ) fill=fill id=id stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-x"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="18" y1="8" x2="23" y2="13"></line><line x1="23" y1="8" x2="18" y2="13"></line></svg>
                    }
                }
                ...
                fn get_usercheck(
                    ...
                    html!{
                        <svg xmlns="http://www.w3.org/2000/svg" witdh=size.0 height=size.1 viewBox=format!("{} {} {} {}",
                            ...
                            view_box.2,
                            view_box.3,
                        ) fill=fill id=id stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg>
                    }
                }
                ...
                fn get_userminus(
                    ...
                    html!{
                        <svg xmlns="http://www.w3.org/2000/svg" witdh=size.0 height=size.1 viewBox=format!("{} {} {} {}",
                            ...
                            view_box.2,
                            view_box.3,
                        ) fill=fill id=id stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-minus"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="23" y1="11" x2="17" y2="11"></line></svg>
                    }
                }
                ...
                fn get_messagesquare(
                    ...
                    html!{
                        <svg xmlns="http://www.w3.org/2000/svg" witdh=size.0 height=size.1 viewBox=format!("{} {} {} {}",
                            ...
                            view_box.2,
                            view_box.3,
                        ) fill=fill id=id stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                    }
                }
